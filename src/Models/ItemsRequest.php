...
class ItemsRequest implements \JsonSerializable
{
    /**
     * @var int|null
     */
     ...
     *
     * @maps pricing
     * @mapsBy anyOf(anyOf(Pricing,Pricing1,Pricing2,Pricing3,Pricing4,Pricing5,Pricing6),null)
     *
    ...
    /**
     * Converts the ItemsRequest object to a human-readable string representation.
     *
     * @return string The string representation of the ItemsRequest object.
     */
        ...
        if (isset($this->pricing)) {
            $json['pricing']  =
                ApiHelper::getJsonHelper()->verifyTypes(
                    $this->pricing,
                    'anyOf(anyOf(Pricing,Pricing1,Pricing2,Pricing3,Pricing4,Pricing5,Pricing6),null)'
                );
        }
