...
use SampleAPILib\Utils\CompatibilityConverter;
use Unirest\Configuration;
use Unirest\HttpClient;

class SampleAPIClient implements ConfigurationInterface
{
    private $client2;
    ...
    /**
     * @see SampleAPIClientBuilder::init()
     * @see SampleAPIClientBuilder::build()
     *
     * @param array $config
     */
     ...
     *
     * @return SampleAPIClientBuilder SampleAPIClientBuilder instance
     */
    public function toBuilder(): SampleAPIClientBuilder
    {
        return SampleAPIClientBuilder::init()
     ...
     *
     * @see SampleAPIClientBuilder::getConfiguration()
     */
     ...
     * @var array
     */
    private const ENVIRONMENT_MAP = [Environment::PRODUCTION => [Server::DEFAULT_ => 'https://api.example.com/v1']];
}
